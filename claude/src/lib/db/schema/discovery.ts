...
export const insightEvidenceLinks = pgTable(
  ...
  (table) => ({
    uniqueLink: uniqueIndex("insight_evidence_unique_idx").on(
      table.insightId,
      table.quoteId
    ),
...
export const insightProblemLinks = pgTable(
  ...
  (table) => ({
    uniqueLink: uniqueIndex("insight_problem_unique_idx").on(
      table.insightId,
      table.problemId
    ),
...
export const problemSolutionLinks = pgTable(
  ...
  (table) => ({
    uniqueLink: uniqueIndex("problem_solution_unique_idx").on(
      table.problemId,
      table.solutionId
    ),
